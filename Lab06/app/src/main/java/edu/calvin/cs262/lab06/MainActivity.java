    ...
    private void convertJSONtoArrayList(JSONObject forecast) {
        ...
        try {
            ...
            for (int i = 0; i < list.length(); i++) {
                ...
                Double minTemp = temperatures.getDouble("min");
                Double maxTemp = temperatures.getDouble("max");
